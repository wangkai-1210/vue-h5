 ...
 * @Description: 
 * @Author: wang_k
 * @Date: 2026-05-25 16:21:39
 * @LastEditTime: 2026-05-26 09:58:22
 * @FilePath: /vue2-mobile-h5/src/views/Mingli/QiMenDunJia copy.vue
-->
<template>
...
export default {
  ...
  methods: {
    ...
    drawJu() {
      ...
      const data = calendarChange.solar2lunar(year, month + 1, day)
      this.nlYMD = data.lYear + '年' + data.IMonthCn + data.IDayCn
